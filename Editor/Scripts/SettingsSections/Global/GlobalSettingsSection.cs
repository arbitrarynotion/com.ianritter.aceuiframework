...
namespace Packages.com.ianritter.aceuiframework.Editor.Scripts.SettingsSections.Global
{
    ...
    {
        protected override string GetRelativePathVarName( string varName ) => AceTheme.GetGlobalSettingsVarName + "." + varName;

        public override Element GetSection() =>
            GetGroupWithFoldoutHeading( nameof( AceTheme.globalSettingsSectionToggle ),
                "Global",
                ...
                GetElement( GetRelativePathVarName( nameof( GlobalSettings.hideScriptField ) ), "Hide Script Fields", "When true, the script field of all ACE UI component participants will be hidden." ),
