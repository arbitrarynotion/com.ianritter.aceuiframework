...
namespace Packages.com.ianritter.aceuiframework.Runtime.Scripts.SettingsGlobal.Colors
{
    ...
    public class CustomColorEntry
    {
        ...
        [SerializeField] [Delayed] public string name;
        [SerializeField] public Color color;
        [SerializeField] public int userCount = 0;
        [SerializeField] public string userList = "Users:";
        ...
        /// <summary>
        ///     Used to track when changes are made to serialized data within the property drawer. This will be set back to false in ColorPaletteSettings
